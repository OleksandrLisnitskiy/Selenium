    ...
    while True:
        try:
            ...
            driver = webdriver.Chrome(chrome_driver,
                                      chrome_options=chrome_options)  # seleniumwire_options=proxy_options
            ...
            driver.execute_script("arguments[0].click();", driver.find_element(By.XPATH,
                                                                               '//*[@id="__next"]/div[1]/div[2]/div/div/div/form/div[2]/div/button'))
            ...
            sleep(1)
            driver.execute_script("arguments[0].click();", driver.find_element(By.XPATH,
                                                                               '//*[@id="__next"]/div[1]/div[2]/div/div/div/form/button'))

            # put additional email
            sleep(1)
            driver.find_element(By.ID, "recoveryEmail").send_keys(
                random.choice(names) + random.choice(surnames) + "@gmail.com")
            sleep(1)
            driver.execute_script("arguments[0].click();", driver.find_element(By.XPATH,
                                                                               '//*[@id="__next"]/div[1]/div[2]/div/div/div/form/div[3]/button'))
            ...
            sleep(1)
            driver.execute_script("arguments[0].click();", driver.find_element(By.XPATH,
                                                                               '//*[@id="__next"]/div[1]/div[2]/div/div/div/form/div[5]/button'))
            sleep(1)
            # Chose plan
            driver.execute_script("arguments[0].click();", driver.find_element(By.XPATH,
                                                                               '//*[@id="__next"]/div[1]/div[2]/div/div/div/div[3]/button'))

            # accept policies
            sleep(0.2)
            driver.execute_script("arguments[0].click();", driver.find_element(By.XPATH,
                                                                               '//*[@id="__next"]/div[1]/div[2]/div/div/div/form/div[1]/button'))
            sleep(1)
            driver.execute_script("arguments[0].click();", driver.find_element(By.XPATH,
                                                                               '//*[@id="__next"]/div[1]/div[2]/div/div/div/form/div[2]/div/button'))
            sleep(4.5)
