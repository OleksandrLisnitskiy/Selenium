...
def main(time):
    ...
    # Dolphin Anti API
    username = "accountsphemex@gmail.com"
    ...
    profile_start = 38   # int(input("Enter the number of profile: "))
    while True:
        ...
        try:
            ...
            # first_quiz(driver, time+1)  # passed
            # second_quiz(driver, time)  # passed
            third_quiz(driver, time)  # passed
            fourth_quiz(driver, time+1)  # passed
            fifth_quiz(driver, time)  # passed
            sixth_quiz(driver, time)  # passed
            seventh_quiz(driver, time)  # passed
            eighth_quiz(driver, time)  # passed
            ninth_quiz(driver, time+1)  # passed
            tenth_quiz(driver, time)  # passed
            eleventh_quiz(driver, time+1)  # passed
